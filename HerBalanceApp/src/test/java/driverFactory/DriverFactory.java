...
public class DriverFactory extends Constants {
    ...
    public WebDriver getDriver() {
        if (driver.get() == null) {
            ...
            if(Constants.browserForCrossbrowserTest != null) {
            	browser = Constants.browserForCrossbrowserTest;
    		System.out.println("getDriver Constants.browserForCrossbrowserTest: "+browser);
            } 	
            else
            	browser = configProp.getString("browser");
